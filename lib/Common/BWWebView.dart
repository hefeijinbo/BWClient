...
class BWWebView extends StatefulWidget {
  var url = "";
  var title = "";
  BWWebView(this.url, this.title, {Key? key}) : super(key: key);

  @override
  _BWWebViewState createState() => _BWWebViewState(url, title);
}

class _BWWebViewState extends State<BWWebView> {
  var url = "";
  var title = "";

  _BWWebViewState(this.url, this.title);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Builder(builder: (BuildContext context) {
        return WebView(
          initialUrl: url,
          userAgent: "User-Agent: Mozilla/5.0 (iPhone; CPU iPhone OS 14_8 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E148/JueJinAPP",
          ...
          navigationDelegate: (NavigationRequest request) {
            if (request.url.startsWith('https://www.youtube.com/')) {
              printLog('blocking navigation to $request}');
              return NavigationDecision.prevent;
            }
            printLog('allowing navigation to $request');
